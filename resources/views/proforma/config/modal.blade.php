<div class="modal fade " aria-labelledby="myModalLabel"  role="dialog" tabindex="-1" id="modal-delete-{{$mo->idTipo_moneda}}" style="padding-left: 17px;border-radius:0px !important;">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-transparent text-center p-md">
                ...
                <p class="p-text-delete">Al eliminar la siguiente Moneda <span style="color: red">{{$mo->nombre_moneda}}</span>  no volvera a verlo en la lista </p>
              </div>
            </div>
