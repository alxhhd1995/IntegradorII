<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$emp->id}}" style="padding-left: 17px;border-radius:0px !important;">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-transparent text-center p-md">
                ...
                <p class="p-text-delete">Al eliminar al siguiente empleado <span style="color: red">{{$emp->nombre}}</span>  no volvera a verlo en la lista </p>
              </div>
            </div>
            <h3>¿Desea eliminar al empleado {{$emp->nombre}}?</h3>
          </div>         
      </center>
  </div>
