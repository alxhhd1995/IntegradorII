...
<section class="content">
                ...
                <div class="box-header with-border" style="padding: 10px !important">
                    <h4>
                        <strong style="font-weight: 400">
                            <i class="fas fa-dolly"></i> Registro de Marcas
                        </strong>
                    </h4>
                    @if(count($errors)>0)
    ...
    {!!Form::open(array('url'=>'proforma/marca','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
                  ...
                  <div class="col-sm-12">
                    ...
                    <label for="" class="control-label" style="font-size: 13px;color: #676a6c">
                      Marca
                                        ...
                                        <div class="col-sm-6">
                      <div class="form-group">
                        <input type="text"     name="nombre_proveedor" class="form-control" placeholder="Ingrese nueva marca...">
                      </div>                
                      </div>
                      <div class="col-sm-6">
