<div class="modal fade in" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal-delete-{{$pro->idProducto}}" style="padding-left: 17px;border-radius:0px !important;">
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-transparent text-center p-md">
                ...
                <p class="p-text-delete">Al eliminar el siguiente producto <span style="color: red">{{$pro->nombre_producto}}</span>  no volvera a verlo en la lista </p>
              </div>
            </div>
