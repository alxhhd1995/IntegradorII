...
{{Form::Open(['route' => ['tablero-eliminar', $prof->idProforma], 'method' => 'delete'])}}
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-transparent text-center p-md">
                ...
                <p class="p-text-delete">Al eliminar la siguiente Proforma Tableros <span style="color: red">{{$prof->serie_proforma.' /  f000-'.$prof->idProforma}}</span>  no volvera a verlo en la lista </p>
              </div>
            </div>
            <h3>¿Desea eliminar la proforma tableros?</h3>
          </div>
